describe("The Scraper Cassette", function() {
  ...
  beforeEach(function() {
    ...
    this.verifyGetBrowseList = function(expectedAttrs, expectedTypes) {
      ...
      for (var i = 0; i < self.testTracks.length; i++) {
        ...
        if (expectedTypes.indexOf(testTrackJSON.type, expectedTypes) != -1) {
      ...
      }, "Timed out waiting for track parsing", 2000);
    };
  ...
  describe("The TrackParser Script", function() {
...
****************************/
    it("should return the *a links* on the page as tracks", function() {
      ...
      this.loadTracksIntoDOM(this.testTracks, asLinks, "Links");
    ...
    it("should return the *<audio> elements* on the page as tracks", function() {
      ...
      this.loadTracksIntoDOM(this.testTracks, asAudio, "Audio");
